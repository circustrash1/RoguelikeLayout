...
class Enemy {
public:
	Enemy(int x, int y, char symbol, int enemyHealth, int attackDamage, float attackCooldown, const sf::Color& color = sf::Color::Green); // Updated constructor declaration
